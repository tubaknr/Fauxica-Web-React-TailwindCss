...
export default function Hero(){
    return(
        <div className="flex justify-between mx-20 font-Inter dark:darkBg">
            <div class="left-hero" className="text-black  m-20 pt-10 w-1/2" >
                <h1 className="text-5xl font-semibold pb-12 dark:text-slate-100">Quality apparel without the price tag</h1>
                <p className="pb-5 dark:text-slate-300">No need to spend $xxx on apparel just for the name's sake. Our premium apparel is made from the same stuff.</p>
                
                <div class="btns" className="flex">
                    <button className="text-black py-4 px-8 rounded-3xl bg-customYellow font-bold ml-5 mr-5 mt-5 mb-2">Browse our collection</button>
                    
                    <a href="#" className="flex justify-between ml-10 pt-4 font-bold custom-slide mt-5 dark:text-slate-300">Spring '24 Collection
                ...
                <div class="text" className="relative flex justify-between mt-10 px-12 py-10 border-2 border-black mr-30 rounded-xl dark:border-slate-300">
                    <p className="text-3xl dark:text-slate-300">50K</p>
                    <p className="pl-12 dark:text-slate-300">We’re proud to announce that we now employ a workforce of over 50,000. It’s all possible because of you.</p>
                    <img src={confetti} className="absolute top-[-.5cm] left-[-.5cm]"/>
                </div>
            </div>

            <div class="right-hero" className="flex mr-20 ml-10 mt-10">
                <Card imgSrc={left} title="Fauxica Sports" itemName="Cardigans" price="$156" topPercentage="65" marginX="40" marginY="90" ticketImg='true'/>
