    ...
    return(
        <div className="flex justify-between mx-20 font-Inter">
            <div class="left-hero" className="text-black  m-20 pt-10 w-1/2" >
                <h1 className="text-5xl font-semibold pb-12">Quality apparel without the price tag</h1>
                ...
                <div class="btns" className="flex">
                    ...
                    <a href="#" className="flex justify-between ml-10 pt-4 font-bold custom-slide mt-5">Spring '24 Collection
