                ...
                <div className="text-center items-start">
                    <form>
                        <div className="flex flex-col m-5">
                            <label for="email" className="text-left my-3">Your email</label>
                            <input type="text" id="email" placeholder="name@flowbite.com" className="p-3 border border-gray-200 rounded-xl w-full"></input>
                        </div>
                        <div className="flex flex-col m-5">
                            <label for="subject" className="text-left my-3">Your subject</label>
                        ...
                        <div className="flex flex-col m-5">
                            <label for="message" className="text-left my-3">Your message</label>
                            <textarea
                                type="text" 
                                id="message" 
                    ...
                    <div className="flex block m-20 italic">
                        <div>
                            <p className="cursor-pointer text-center m-5">+44 117 847490</p>
                            <p className="cursor-pointer text-center m-5">info@fauxica.co.uk</p>
                            <p className="cursor-pointer m-5 mb-20 text-center">KT1 1AR, Kingston upon Thames, London, UK.</p>
                    ...
                    <p className="mt-40">All Rights Reserved. Tuba Culhaoglu 2024.</p>
            </div>
        </div>
    );
}
